 ...
 * Description: 
 *    This file contains the implemetation of reverse reconciliation. It can be used to read the quantum states of Alice and Bob from files and perform the reconciliation. It prints the statistics of the reconciliation process.
 * Author: Erdem Eray Cil
 * License: GPL-3.0 License
 * Revision History:
 *    11/06/2024 - v0.1 - First pre-release version
 *    31/07/2024 - v1.0 - Release version 
 ********************************************************************/
...
int main(int argc, char *argv[])
{
    ...
    bool fast_decoding_flag = true; // true: fast decoding, false: normal decoding
    ...
    bool layered_decoding_flag = true; // true: layered decoding, false: flooding decoding
    ...
    parser.add_option({"bool", 'f', "Fast decoding", 0, "Fast decoding flag",0}, fast_decoding_flag);
    ...
    parser.add_option({"bool", 'l', "Layered decoding", 0, "Layered decoding flag",0}, layered_decoding_flag);
